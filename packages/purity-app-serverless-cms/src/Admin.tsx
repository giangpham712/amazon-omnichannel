...
import { Admin as BaseAdmin } from '@purity/app-admin';
import { AdminProps as BaseAdminProps, AppInstaller, Provider } from '@webiny/app-admin';
...
import { createApolloClient as defaultApolloClientFactory } from '@webiny/app-serverless-cms/apolloClientFactory';
import apolloLinks from '@webiny/app-serverless-cms/apolloLinks';
